                        ...
                        <tbody>
                            @foreach ($states as $state)
                                <tr>
                                    ...
                                    <td>{{ date('d/M/Y H:i', strtotime($state->created_at)) }}</td>
                                    <td>
                                        ...
                                        <button type="button"
                                            class="btn btn-soft-danger waves-effect waves-light deleteState"
                                            id="{{ $state->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Are you sure to delete this state?</h5>
...
@section('script')
    ...
    <script>
        $("body").delegate(".deleteState", "click", function() {
            var id = this.id;

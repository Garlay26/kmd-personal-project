                    ...
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td><img src="{{ $category->image }}" alt="" width="50px" height="auto"></td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button"
                                            ...
                                            id="{{ $category->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Are you sure to delete this category?</h5>

                                ...
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="example-text-input"
                                            name="title" required value="{{$outcome->title}}">
                                            <input type="hidden" name="id" value="{{$outcome->id}}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="datepicker-basic" name="date" required value="{{$outcome->date}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" id="example-text-input"
                                            name="amount" required value="{{$outcome->amount}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div>
                                    <div class="mb-3">
                                        ...
                                        <textarea name="remark" id="" cols="30" rows="10" class="form-control">{{$outcome->remark}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">

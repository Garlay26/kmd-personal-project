                    ...
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            @foreach ($banners as $banner)
                                <tr>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td><img src="{{ $banner->image }}" alt="" width="50px" height="auto"></td>
                                    <td>{{ $banner->link }}</td>
                                    <td>
                                        ...
                                        <button type="button"
                                            class="btn btn-soft-danger waves-effect waves-light deleteBanner"
                                            id="{{ $banner->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Are you sure to delete this banner?</h5>
...
@section('script')
    ...
    <script>
        $("body").delegate(".deleteBanner", "click", function(){
             var id = this.id;

                    ...
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            @foreach ($brands as $brand)
                                <tr>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td><img src="{{ $brand->image }}" alt="" width="50px" height="auto"></td>
                                    <td>{{ $brand->title }}</td>
                                    <td>
                                        ...
                                        <button type="button"
                                            class="btn btn-soft-danger waves-effect waves-light deleteBrand"
                                            id="{{ $brand->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Are you sure to delete this brand?</h5>

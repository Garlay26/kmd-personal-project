...
option = {
    ...
    color: mixlinebarColors, //['#1e92e0', '#1e92e0', '#fd625e'],
    legend: {
...
option = {
    ...
    color: doughnutColors, //['#1e92e0', '#ffbf53', '#fd625e', '#4ba6ef', '#1e92e0'],
    series: [
        {
            name:'Total sales',
            type:'pie',
...
option = {
    ...
    color: pieColors, //['#fd625e', '#1e92e0', '#4ba6ef', '#ffbf53', '#1e92e0'],
    series : [
        {
            name: 'Total sales',
            type: 'pie',
